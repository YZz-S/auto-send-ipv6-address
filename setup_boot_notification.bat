...
:: 设置VBS脚本名称
set "VBS_SCRIPT_NAME=start_boot_notification.vbs"
set "PYTHON_SCRIPT_NAME=boot_notification.py"
...
echo oLink.Description = "Boot Notification Sender" >> "%TEMP%\CreateShortcut.vbs"
